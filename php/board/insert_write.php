...
<?
    ...
    //글 삽입 명령
    $sql="insert into $boardname (userID,subject,country,region,requiredPeople,engagedPeople,title,contents,app_date) 
        values('$userId','$subject','$country','$region','$requiredPeople','$engagedPeople','$title','$content','$app_date')";
    echo($sql);
     $result = mysql_query($sql,$connect) or exit(mysql_error());
